...
$json | Out-File -FilePath "C:\Users\USER\Documents\APP PARA CAMBIOS JK CONVERSOR\workflow_bot_whatsapp_v10.json" -Encoding utf8
Write-Output ("JSON v10 generado. Longitud: " + $json.Length + " chars. Nodos: " + $nodes.Count)
