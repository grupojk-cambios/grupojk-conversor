...
$nodes = @(
  ...
  [ordered]@{
    ...
    type = 'n8n-nodes-base.code'; typeVersion = 2; position = @(1780,128); id = '6ac06fc7-1afb-49ab-893c-e2f2b5f8b995'; name = 'Code in JavaScript'
  },
  [ordered]@{
...
$json | Out-File -FilePath "C:\Users\USER\Documents\APP PARA CAMBIOS JK CONVERSOR\workflow_bot_whatsapp_v6.json" -Encoding utf8
Write-Output ("JSON v6 generado. Longitud: " + $json.Length + " chars. Nodos: " + $nodes.Count)
